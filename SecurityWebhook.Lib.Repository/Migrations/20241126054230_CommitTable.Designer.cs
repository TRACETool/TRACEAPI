...
namespace SecurityWebhook.Lib.Repository.Migrations
{
    ...
    [Migration("20241126054230_CommitTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecurityWebhook.Lib.Repository.Entities.CommitStore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SecurityWebhook.Lib.Repository.Entities.RepoScanMetadata", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SecurityWebhook.Lib.Repository.Entities.RepoScanMetadata", b =>
                {
                    b.HasOne("SecurityWebhook.Lib.Repository.Entities.RepositoryMaster", "RepositoryMaster")
                        .WithOne("Metadata")
                        .HasForeignKey("SecurityWebhook.Lib.Repository.Entities.RepoScanMetadata", "RepoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RepositoryMaster");
                });
